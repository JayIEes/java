...
public class UseManualLayout extends JFrame {
	...
	public UseManualLayout() {
		...
		String[] data="전민정,정인선,장정우,김진영,김현우".split(",");//csv data
		JList<String> jl=new JList<String>(data);
		
		//색 변경
		//바닥 색
		jlbl.setOpaque(true);//투명도 해체
//		jlbl.setBackground(Color.YELLOW); //바닥색 설정
		jlbl.setBackground(new Color(0xD5D5D5)); //바닥색 설정
		//전경색
